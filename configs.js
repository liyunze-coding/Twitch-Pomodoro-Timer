const configs = (function () {
	...
	const obs = {
		changeScenes: false, // true or false
		sceneWork: "", // scene name for when it's work time
		sceneBreak: "", // scene name for when it's break time
		sceneOver: "", // scene name for when pomodoros are all finished
		port: "4455", // OBS WebSocket port
		password: "", // set this in OBS WebSocket settings
	...
	const discord = {
		...
		roleID: "", // role id to ping, can be obtained by right clicking on the role (ensure to have developer mode on)
